...
<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 1-1"></center>
...
<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 1-2"></center>

- Click on the server name, you can see the server admin name.

<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 1-3"></center>
...
<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 1-4"></center>
...
<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 1-5"></center>
...
<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 2-1"></center>
...
<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 2-2"></center>

	- Select **Database**. 
	- Provide your credentials by entering your user name (admin name) and password in the corresponding fields
	- Click **Connect**

<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 2-3"></center>

	- Navigate to your dataset, click to select then Click **Transform data** to open the dataset in Power Query.

<center><img src="/images/how_to_connect_to_Azure_SQL_database_to_Query_data/Step 2-4"></center>
